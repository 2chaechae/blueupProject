				...
				<div class="board-write">
					<table summary="1:1고객상담 입력">
						...
						<tr>
							...
							<td>
								<input type="text" id="boardWriteTitle" class="input-style01" name="title" value="${vo.qna_title }" style="width:515px;" readonly>
						...
						<tr>
							...
							<td>
								<textarea name="content" cols="30" rows="10" id="boardWriteContent" style="width:515px; height:150px;" readonly>${vo.qna_content }</textarea>
			 	...
			 	<div class="btnWrapBox">
					<input type="button" id="toList" value="목록으로" style="width:200px; margin-right:2px; padding: 20px 40px; font-size: 14px;
															...
															min-width: 220px; "/>
					<input type="button" id="delete" value="삭제" style="width:200px; margin-right:2px; padding: 20px 40px; font-size: 14px;
															box-sizing: border-box; border: 1px sold black; color: white; background: black;
															display: inline-block; vertical-align: middle; text-align: center; cursor: pointer; white-space: nowrap;
															min-width: 220px;"/>
					<input type="button" id="modify" value="수정" style="width:200px; margin-right:2px; padding: 20px 40px; font-size: 14px;
															box-sizing: border-box; border: 1px sold black; color: black; background: white;
															display: inline-block; vertical-align: middle; text-align: center; cursor: pointer; white-space: nowrap;
															min-width: 220px;" />
							...
							$(document).ready(function(){
								...
								$(document).ready(function(){
									...
									$('#delete').on('click',function(){
										location.href="/test/qnaDelete.do?user_no="+${user_no}+"&qna_no="+${qna_no};
									});
								});
								...
								$(document).ready(function(){
									...
									$('#modify').on('click',function(){
										location.href="/test/modifyQna.do?user_no="+${user_no}+"&qna_no="+${qna_no};
									});
								});
							</script>
