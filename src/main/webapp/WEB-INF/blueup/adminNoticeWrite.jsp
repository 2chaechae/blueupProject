         ...
         <main class="contents oto_inquiryWrite-wrap" id="contents">
            ...
            <div class="board-write" style="width:900px; height:295px; margin:0 auto; margin-top:20px;">
               <table summary="1:1고객상담 입력">
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <select name="notice_type" style="width: 200px;
                                                 padding: .8em .5em;
                                                 font-family: inherit;
                  ...
                  <tr>
                     ...
                     <td>
                        <input type="text" id="boardWriteTitle" class="input-style01" name="notice_title" placeholder="제목을 입력해 주세요." style="width:586px;">
                  ...
                  <tr>
                     ...
                     <td>
                        <textarea name="notice_content" cols="30" rows="10" id="boardWriteContent" placeholder="내용을 입력해 주세요." style="width:515px; height:150px;"></textarea>
             ...
             <div class="btnWrapBox">
               <input type="button" id="cancelBtn" class="btn btn-style03" value="취소" />
