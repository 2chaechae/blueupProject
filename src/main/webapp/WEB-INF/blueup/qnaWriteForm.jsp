	...
	<div class="board_wrap">
		...
		<form action="/test/qnaWriteProc.do?pageNum=1" id="form">
			...
			<div class="radio_boxs" align="center">
				<input class="radio-value" id="false" type="radio" name="open"
					value="false" checked> <label for="false">공개글</label> <input
					class="radio-value" id="true" type="radio" name="open" value="true">
				<label for="true">비밀글</label>
			</div>
			...
			<div class="buttons_area">
				<button class="board_btn cancle"
					onClick="location.href='/test/qna.do?pageNum=1'; return false">취소</button>
