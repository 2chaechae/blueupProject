		...
		<main class="contents ratingBenefit-wrap" id="contents">
							...
							<th scope="col">
								<div>
									<img
										...
										alt="PLATINUM VVIP"> <strong class="lv">PLATINUM VVIP</strong>
								</div>
							</th>
						</tr>
					</thead>
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<th rowspan="2" scope="row">포인트</th>
							<td rowspan="2">
								<div class="CouponST-box">
									<div class="CouponST">
										<img
											src="https://static.mlb-korea.com/pc/static/images/my/ratingBenefit-point.png"
											alt="포토리뷰 작성 1,000원">
										<p>포토리뷰 작성 1,000원</p>
									</div>
									<div class="CouponST">
			...
			<div class="rating-guide-desc">
				<div class="title-list">
					<div class="title">
						등급 산정 및 <br>포인트 적립 안내
					</div>
					<ul class="text-list02">
						<li>등급 산정은 최근 1년 이내 F&amp;F 통합 멤버십 기준 브랜드 구매 금액 합산 기준입니다.</li>
						<li>등급 승급에 의한 혜택은 주문 건에 대한 구매 확정 후 익일에 등급 산정하여 반영됩니다.</li>
						<li class="strong">SALE / OUTLET 상품 구매 시 포인트 사용과 적립이 제외됩니다.
						</li>
					</ul>
				</div>
				...
				<div class="title-list">
					...
					<ul class="text-list02">
						<li>포토리뷰, 텍스트 리뷰 작성 포인트는 구매확정 후 90일 이내 작성하신 경우에만 적립 가능합니다.</li>
						<li>온라인 1천원 이상 적립 시 1천원 단위로 사용 가능합니다. (오프라인 1만원 이상 적립 시 사용
							가능)</li>
						<li class="strong">멤버십 포인트의 사용은 할인 제품 구매 시 적용 제외됩니다.</li>
						<li>결제금액 Payback 포인트는 구매확정 이후 사용 가능합니다.</li>
						<li>멤버십 포인트는 주문 건 별 최종 구매 금액의 50%까지 사용 가능합니다.</li>
						<li>멤버십 포인트는 최종 구매일로부터 2년 경과 후 포인트의 소멸 안내 후 소멸되어, 사용 불가합니다.</li>
					</ul>
				</div>
