				...
				<div class="tbst-div">
					<div class="mid fl">
						<span>전체</span> (<span class="text-color01"><em class="num"
							id="inquiryCnt"></em></span>건)
					</div>
					<div class="mid fr">
						<a href="#" class="btn fill sm fdlr30 btn-style07 right"
							onclick="javascript:goInquiryNew()"><span>약관 등록</span></a>
					</div>
				</div>
				<div id="includeInquiryList">
					<div class="board-list">
						<table>
							...
							<tbody>
								<tr>
									<td colspan="5" class="no-result">약관내용이 없습니다.</td>
								</tr>
							</tbody>
						</table>
					</div>
