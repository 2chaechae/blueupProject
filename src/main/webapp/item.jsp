...
<!--///////////////////item///////////////////////	-->
	...
	<!--///////jewerly////////-->
			...
			<div class="item_con">
				<div class="item">
					...
					<div class ="item_img">
							...
							<div class="item_hover">
								<img src="images/item/jewerly3_hover.png" alt="워머니트" width="300" height="300">
		...
		<div class="items">
			...
			<p class="item_btn"><a href="jewerly.html">Watch 더보기</a></p>
		</div><!--items-->
		...
		<div class="items">
			...
			<p class="item_btn"><a href="jewerly.html">Perfume 더보기</a></p>
		</div><!--items-->
		...
		<div class="items">
			...
			<p class="item_btn"><a href="home.html">Home &amp; accessory 더보기</a></p>
		</div><!--items-->
	</div><!--item_wrap-->
	<!--////////item notice////////-->
	<div id="notice_wrap">
