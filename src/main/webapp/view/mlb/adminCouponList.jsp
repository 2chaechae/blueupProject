				...
				<div class="orderInfoCon">
					...
					<div class="odSearchOptBox">
						<form  method="post" id="srchForm" action ="/secured/mypage/listClaim" >
							...
							<dl class="period-wrap period-type02 clearfix">
								<!-- 기간달력 -->
								<dt class="blind">고객</dt>
								<dd class="fl">
									<!-- select -->
									<div class="select-style02 d_select">
										<button type="button" class="d_select_sel" style="width:152px;"><span>고객선택</span></button>
										<!-- 2018.12.06 항목 수정 -->
										<ul>
											<li><a href="#" onclick="setClmTpCdSearch('');">전체 고객</a></li>
											<li><a href="#" onclick="setClmTpCdSearch('CNCL');">신규 고객</a></li>
											<li><a href="#" onclick="setClmTpCdSearch('GNRL_EXCHG');">재구매 고객</a></li>								
					...
					<div class="odSearchResult">	
						...
						<div class="odResultTop">
							...
							<a href="#" class="btn sm fill" onclick="mypageorder.goInquiryList();return false;">쿠폰등록</a>	
