		...
		<div class="container">
			...
			<div class="location-container">
				...
				<div class="join-wrap">
					...
					<!-- 가입정보 -->
					<form id="joinMbrForm" name="joinMbrForm" action="/member/join/add" method="post"><input type="hidden" name="REQ_SEQ" id="REQ_SEQ"/>
									...
									<tr>
										...
										<td>
											<ul class="dt-list">
												...
												<li id="mbrNmAfter">													
													<input type="text" class="input-style01 name" placeholder="이름(실명입력)" name="mbrNm" id="mbrNm" validate='required' validateText="이름(실명입력)" /><span class="rdo-skin">
												...
												<li id="birthAfter">													
													<span class="birth">
														<input type="text" class="input-style01 year" style="width:80px;" placeholder="생년(4자)" name="birthyear" id="birthyear" maxlength="4" validate='birthyear;number'><input type="hidden" name="birthmonth" id="birthmonth" validate='birthmonth'/>														
										...
										<td>
											<div class="d_toggle togbox">
												<div class="hbox">
													...
													<a href="#" class="btn fill sm btnPslCertifi" onclick="goCertification(this); return false;" data-ga-category="PC_MLB_회원가입" data-ga-action="본인인증" data-ga-label="인증번호받기">본인인증</a>
...
</div></form><div class="bot-btns btnList">
